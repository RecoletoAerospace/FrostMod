...
namespace StarshipFrost;

public class ModuleStarshipFrost : PartModule
{
	public const string MODULENAME = "ModuleStarshipFrost";
	...
	[KSPField]
	public string ModuleID = "ModuleStarshipFrost";
	...
	public void Start()
	{
		...
		{
			Debug.LogWarning((object)string.Format("[{0}] Animation: {1} not found on part: {2}", "ModuleStarshipFrost", FuelAnimName, ((PartModule)this).part));
		}
		else
		{
		...
		{
			Debug.LogWarning((object)string.Format("[{0}] Animation: {1} not found on part: {2}", "ModuleStarshipFrost", OxidAnimName, ((PartModule)this).part));
			return;
		}
	...
	public void FixedUpdate()
	{
		if ((Object)(object)parentpart == (Object)null && (Object)(object)((PartModule)this).part.parent != (Object)null)
		{
			...
			if (num2 != -1)
			{
				...
				Debug.Log((object)("[ModuleStarshipFrost] Found oxidizer tank with resource: " + OxidTank.resourceName));
			}
			num = 0.0;
			num2 = -1;
			...
			if (num2 != -1)
			{
				...
				Debug.Log((object)("[ModuleStarshipFrost] Found fuel tank with resource: " + FuelTank.resourceName));
			}
		}
